...
const ContactForm = () => {
    ...
    return (
        <form id='contact-form' className="contact__form" name="Contact Form" method="POST" data-netlify="true">
            ...
            <div className="contact__input-section contact__input--text">
                <input name='phone' type="text" className="contact__input contact__input--phone" id="phone" placeholder="Enter your phone number"/>
            </div>
            <div className="contact__input-section contact__input--email">
                <input name='email' type="email" className="contact__input contact__input--email" id="email" placeholder="Enter your email address *" required/>
            </div>
            <div className="contact__input-section contact__input--select">
                <select name="assistance-type" className="contact__input contact__input--assistance-type" id="req" required>
            ...
            <div className="contact__input-section contact__input--text-area">
                <textarea name="message" autoComplete="on" className="contact__input-text-area contact__input-text-area--msg" id="msg" rows="3" placeholder='Enter your message'></textarea>
            </div>
            {/* <ReCAPTCHA size='normal' sitekey='6LeDX-UUAAAAAMIYoGlvS3xxpfWpHqrT6MDz0RB4' onChange={handleCaptchaChange}/> */}
            <CustomButton className="contact__input-submit" type="submit">SUBMIT</CustomButton>
        </form>
    )
}
