            ...
            <div className="navbar__content">
                ...
                <nav id="navigation" className={`navbar__menu ${navToggled ? 'navbar__menu--active' : ''}`} aria-labelledby="menubutton">
                    <ul className="navbar__nav-list" role="menubar">
                        ...
                        <li className="navbar__item" role="none">
                            <Link onClick={closeNav} className="navbar__link" to='/our-picks' role="menuitem">Our Picks</Link>
                        </li>
                        <li className="navbar__item" role="none">
                            <Link onClick={closeNav} className="navbar__link" to='/about' role="menuitem">About</Link>
                        </li>
                        <li className="navbar__item" role="none">
                            <Link onClick={closeNav} className="navbar__link" to='/contact' role="menuitem">Contact</Link>
                        </li>
                    </ul> 
                </nav>
